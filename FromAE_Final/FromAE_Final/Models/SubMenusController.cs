...
namespace FromAE_Final.Models
{
    public class SubMenusController : Controller
    {
        ...
        {
            ViewData["MenuId"] = new SelectList(_context.Menus, "Id", "Link");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Link,MenuId")] SubMenu subMenu)
        {
            ...
            ViewData["MenuId"] = new SelectList(_context.Menus, "Id", "Link", subMenu.MenuId);
            return View(subMenu);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Link,MenuId")] SubMenu subMenu)
        {
            if (id != subMenu.Id)
            {
                return NotFound();
