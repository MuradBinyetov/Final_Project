...
namespace FromAE_Final.Controllers
{
    ...
    public class MarkasController : Controller
    {
        ...
        public MarkasController(FromAeDbContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Markas.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Marka marka)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Marka marka)
        {
            if (id != marka.Id)
            {
                return NotFound();
