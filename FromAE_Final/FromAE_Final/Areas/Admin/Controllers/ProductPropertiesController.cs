...
namespace FromAE_Final.Controllers
{
    ...
    public class ProductPropertiesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? productId, int? propertyId)
        {
            //if (id == null)
            //{
            //    return NotFound();
            ...
            var productProperty = await _context.ProductProperties.FindAsync(productId,propertyId);
            if (productProperty == null)
            {
                return NotFound();
            }
        ...
        {
            if (id != productProperty.ProductId)
            {
                return NotFound();
            }
        ...
        {
            return _context.ProductProperties.Any(e => e.ProductId == id);
        }
    }
}
