...
namespace FromAE_Final.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(FromAeDbContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Image,Link,SubMenuId")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
