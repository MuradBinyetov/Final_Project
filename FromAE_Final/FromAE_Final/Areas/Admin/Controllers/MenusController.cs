...
namespace FromAE_Final.Areas.Admin.Controllers
{
    ...
    public class MenusController : Controller
    {
        ...
        public MenusController(FromAeDbContext context, IStringLocalizer sharedLocalizer)
        {
            _context = context;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Link")] Menu menu)
        {
            if (id != menu.Id)
            {
                return NotFound();
