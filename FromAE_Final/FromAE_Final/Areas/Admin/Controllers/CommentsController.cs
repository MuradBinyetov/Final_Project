...
namespace FromAE_Final.Controllers
{
    ...
    public class CommentsController : Controller
    {
        ...
        public CommentsController(FromAeDbContext context)
        {
            _context = context;
        }
        ...
        {
            var fromAeDbContext = _context.Comments.Include(c => c.Product);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,Description,ProductId")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
