...
namespace FromAE_Final.Controllers
{
    ...
    public class RatingsController : Controller
    {
        ...
        public RatingsController(FromAeDbContext context)
        {
            _context = context;
        }
        ...
        {
            var fromAeDbContext = _context.Ratings.Include(r => r.Product);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Star,ProductId")] Rating rating)
        {
            if (id != rating.Id)
            {
                return NotFound();
